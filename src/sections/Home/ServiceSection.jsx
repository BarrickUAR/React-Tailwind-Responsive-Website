      ...
      <div className="container mx-auto p-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 mb-9 mt-3">
          <div className="text-center p-4 rounded-xl service-item">
            <svg
              className="w-24 h-24 mx-auto p-3 mb-4 text-second-light bg-gray-800 rounded-full hover:scale-125 transition duration-300 hover:duration-1000"
            ...
            <p className="dark:text-white text-black">
              Description lorem ipmsum falan
            </p>
          </div>
