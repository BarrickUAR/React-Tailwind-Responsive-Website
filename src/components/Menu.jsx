    ...
    <div>
          ...
          <div className="absolute left-0 top-0 w-72 h-full z-50 bg-white dark:bg-black text-second-light dark:text-white">
            ...
            <div>
              <Link to="/">
                {" "}
                <a
                  className="block px-4 py-2 font-semibold font-roboto hover:underline"
                  href="#"
                >
                  Home
                </a>{" "}
      ...
      <div className="container mx-auto flex items-center justify-between px-4">
        ...
        <div className="hidden md:flex space-x-4">
          <Link to="/">
            {" "}
            <a className="text-white text-xl hover:underline transition ">
              Home
            </a>{" "}
          </Link>
          <a
        ...
        <div className="flex items-center space-x-4">
          ...
          <a
            onClick={toggleMobileMenu}
            className="text-white text-xl lg:hidden flex"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
