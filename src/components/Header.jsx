          ...
          <section className="relative h-full overflow-hidden">
            ...
            <div className="flex flex-col lg:flex-row justify-between items-center py-28 px-5 relative z-10">
              <div className="lg:w-1/2 space-y-6">
                <h2 className="uppercase text-3xl lg:text-6xl font-poppins font-semibold text-white">
                  1lorem ipmsum title
                </h2>
                <h3 className="text-lg lg:text-xl font-roboto text-yellow-400">
                  Lorem Ipsum is simply dummy text of the printing and
                  typesetting industry. Lorem{" "}
                </h3>
                <p className="text-sm font-lora text-white">
                  Lorem Ipsum is simply dummy text of the printing and
        ...
        <SwiperSlide>
          <section className="relative h-full overflow-hidden">
            <div
              ref={slideref3}
              className="absolute top-0 left-0 w-full h-full bg-cover bg-center"
              style={{ backgroundImage: 'url("img/slider/slider1.jpg")' }}
            ></div>
            <div className="absolute top-0 left-0 w-full h-full bg-opacity-70 bg-black"></div>
            <div className="hidden dark:block absolute top-0 left-0 w-full h-full bg-opacity-70 bg-black"></div>
            <div className="flex flex-col lg:flex-row justify-between items-center py-28 px-5 relative z-10">
